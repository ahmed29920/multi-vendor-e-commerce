    ...
    <div class="container-fluid p-4 p-lg-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <h1 class="h3 mb-0">{{ __('Create Slider') }}</h1>
                <p class="text-muted mb-0">{{ __('Add a new slider image to your homepage') }}</p>
            </div>
            <div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.sliders.store') }}" method="POST" enctype="multipart/form-data" id="sliderForm">
                            ...
                            <div class="mb-4">
                                ...
                                @enderror
                                <div class="form-text">{{ __('Recommended size: 1920x600px. Supported formats: JPG, PNG, GIF.') }}</div>
                            </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="bi bi-check-circle me-2"></i>{{ __('Create Slider') }}
                                </button>
                            </div>
                        </form>
                    </div>
