...
@section('content')
    ...
    <div class="container-fluid p-4 p-lg-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h3 mb-0">{{ __('Create Plan') }}</h1>
                <p class="text-muted mb-0">{{ __('Add a new subscription plan') }}</p>
            </div>
            <div>
                        ...
                        <form action="{{ route('admin.plans.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" min="0" class="form-control @error('max_products_count') is-invalid @enderror"
                                    id="max_products_count" name="max_products_count" value="{{ old('max_products_count', '') }}">
                            ...
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input @error('can_feature_products') is-invalid @enderror" type="checkbox" id="can_feature_products"
                                        name="can_feature_products" value="1" {{ old('can_feature_products') ? 'checked' : '' }}>
                            ...
                            <div class="d-flex gap-2">
                                <button type="submit" class="btn btn-primary">
                                    <i class="bi bi-check-lg me-2"></i>{{ __('Create Plan') }}
                                </button>
