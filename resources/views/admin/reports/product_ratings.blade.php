    ...
    <div class="container-fluid p-4 p-lg-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted mb-0">{{ __('Manage product ratings') }}</p>
            </div>
        </div>
                            ...
                            <tbody>
                                @foreach($ratings as $rating)
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <form action="{{ route('admin.product-ratings.toggle-visibility', $rating) }}" method="POST" class="d-inline toggle-visibility-form">
                                                @csrf
    ...
    @push('scripts')
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                const forms = document.querySelectorAll('.toggle-visibility-form');
