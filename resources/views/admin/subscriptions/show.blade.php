            ...
            <div>
                <nav aria-label="breadcrumb" class="mb-2">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.subscriptions.index') }}">{{ __('Subscriptions') }}</a></li>
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <strong class="d-block">
                                            @if($subscription->vendor)
                                                {{ $subscription->vendor->getTranslation('name', app()->getLocale()) }}
                                            @else
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="border-start border-primary border-3 ps-3">
                                    <label class="form-label text-muted small mb-1">{{ __('Vendor') }}</label>
                        ...
                        <div class="text-center mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                @else
                                    ...
                                    <p class="text-muted mb-0">{{ __('Starts in') }} {{ $daysRemaining }} {{ __('days') }}</p>
                                @endif
                            </div>
                        </div>
