    ...
    <div class="container-fluid p-4 p-lg-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted mb-0">{{ __('Manage Vendors Subscriptions') }}</p>
            </div>
                    ...
                    <div class="col-md-8">
                        <div class="input-group">
                            ...
                            <input type="text"
                                   class="form-control"
                                   id="searchInput"
                                   placeholder="{{ __('Search subscriptions by vendor name...') }}"
        ...
        <div id="paginationContainer">
            @include('admin.subscriptions.partials.pagination', ['subscriptions' => $subscriptions])
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadSubscriptions(currentFilters) {
        ...
        const url = '{{ route('admin.subscriptions.index') }}' + (params.toString() ? '?' + params.toString() : '');
    ...
    document.addEventListener('click', function(e) {
        if (e.target.closest('.pagination a')) {
            ...
            const newUrl = '{{ route('admin.subscriptions.index') }}' + (params.toString() ? '?' + params.toString() : '');
