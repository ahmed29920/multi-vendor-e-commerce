            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom">
                <div class="container-fluid">
                    ...
                    <a class="navbar-brand d-flex align-items-center" href="./index.html">
                        <img src="{{ asset('dashboard') }}/assets/images/logo.svg" alt="Logo" height="32"
                    ...
                    <div class="navbar-nav flex-row">
                        ...
                        <div class="dropdown me-2">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li><a class="dropdown-item text-center" href="#">View all notifications</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="dropdown">
                            <button class="btn btn-outline-secondary d-flex align-items-center" type="button"
                                data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="{{ asset('dashboard') }}/assets/images/avatar-placeholder.svg" alt="User Avatar" width="24"
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#" data-bs-toggle="collapse"
                                data-bs-target="#elementsSubmenu" aria-expanded="false">
